...
To propose a new topic or collection, please **sort Notebook above files request** with your proposed additions. The [API docs](./docs/API.md) and [shift+browse menus](./docs/styleguide.md) provide guidance on the information you need to include and how it should be formatted.
